            ...
            <div className="navbar-fixed">
                <nav>
                    <div className="nav-wrapper grey lighten-2 z-depth-1">
                        <a href="/feed" className="brand-logo black-text text-lighten-4 left"><i className="material-icons">home</i>Home</a>
                        ...
                        <form>
                            <div className="input-field right grey lighten-3">
